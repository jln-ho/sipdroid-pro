...
import org.sipdroid.sipuapro.phone.CallCard;
import org.sipdroid.sipuapro.phone.Phone;
import org.sipdroid.sipuapro.phone.SlidingCardManager;
	...
	public void onResume() {
		...
		case UserAgent.UA_STATE_INCOMING_CALL:
			if (Receiver.pstn_state == null || Receiver.pstn_state.equals("IDLE"))
				if (PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(org.sipdroid.sipuapro.ui.Settings.PREF_AUTO_ON, org.sipdroid.sipuapro.ui.Settings.DEFAULT_AUTO_ON) &&
						!mKeyguardManager.inKeyguardRestrictedInputMode())
					mHandler.sendEmptyMessageDelayed(MSG_ANSWER, 1000);
				else if ((PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(org.sipdroid.sipuapro.ui.Settings.PREF_AUTO_ONDEMAND, org.sipdroid.sipuapro.ui.Settings.DEFAULT_AUTO_ONDEMAND) &&
						PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(org.sipdroid.sipuapro.ui.Settings.PREF_AUTO_DEMAND, org.sipdroid.sipuapro.ui.Settings.DEFAULT_AUTO_DEMAND)) ||
						(PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(org.sipdroid.sipuapro.ui.Settings.PREF_AUTO_HEADSET, org.sipdroid.sipuapro.ui.Settings.DEFAULT_AUTO_HEADSET) &&
								Receiver.headset > 0))
	        ...
	        (t = new Thread() {
				public void run() {
					...
					if (Settings.System.getInt(getContentResolver(),
						...
						tg = new ToneGenerator(AudioManager.STREAM_VOICE_CALL, (int)(ToneGenerator.MAX_VOLUME*2*org.sipdroid.sipuapro.ui.Settings.getEarGain()));
					for (;;) {
						if (!running) {
							t = null;
							break;
