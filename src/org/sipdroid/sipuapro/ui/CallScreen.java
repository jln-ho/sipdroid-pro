...
import org.sipdroid.sipuapro.ui.InstantAutoCompleteTextView;
...
public class CallScreen extends Activity implements DialogInterface.OnClickListener {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case VIDEO_MENU_ITEM:
			...
			try {
				intent = new Intent(this, org.sipdroid.sipuapro.ui.VideoCamera.class);
					...
					for (;;) {
						...
						if (videopacket.getPayloadLength() > 200) {
							if (intent != null) {
								...
								Intent i = new Intent(mContext, org.sipdroid.sipuapro.ui.VideoCamera.class);
