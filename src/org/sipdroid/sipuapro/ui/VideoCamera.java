...
public class VideoCamera extends CallScreen implements 
    ...
    public void onStart() {
        ...
        videoQualityHigh = PreferenceManager.getDefaultSharedPreferences(mContext).getString(org.sipdroid.sipuapro.ui.Settings.PREF_VQUALITY, org.sipdroid.sipuapro.ui.Settings.DEFAULT_VQUALITY).equals("high");
    ...
    public void onResume() {
        ...
        if (!justplay) {
	        ...
	        startVideoRecording();
        } else if (Receiver.engine(mContext).getRemoteVideo() != 0 && PreferenceManager.getDefaultSharedPreferences(this).getString(org.sipdroid.sipuapro.ui.Settings.PREF_SERVER, org.sipdroid.sipuapro.ui.Settings.DEFAULT_SERVER).equals(org.sipdroid.sipuapro.ui.Settings.DEFAULT_SERVER)) {
