...
import org.sipdroid.sipua.R.drawable;
import org.sipdroid.sipua.R.string;
import org.sipdroid.sipuapro.ui.ChangeAccount;
import org.sipdroid.sipuapro.ui.LoopAlarm;
import org.sipdroid.sipuapro.ui.Receiver;
import org.sipdroid.sipuapro.ui.Settings;
import org.sipdroid.sipuapro.ui.Sipdroid;
...
public class SipdroidEngine implements RegisterAgentListener {
	...
	public boolean StartEngine() {
			...
			if (wl == null) {
				if (!PreferenceManager.getDefaultSharedPreferences(getUIContext()).contains(org.sipdroid.sipuapro.ui.Settings.PREF_KEEPON)) {
					Editor edit = PreferenceManager.getDefaultSharedPreferences(getUIContext()).edit();
	
					edit.putBoolean(org.sipdroid.sipuapro.ui.Settings.PREF_KEEPON, true);
					edit.commit();
				}
			...
			for (UserAgentProfile user_profile : user_profiles) {
				if (wl[i] == null) {
					...
					if (!PreferenceManager.getDefaultSharedPreferences(getUIContext()).getBoolean(org.sipdroid.sipuapro.ui.Settings.PREF_KEEPON, org.sipdroid.sipuapro.ui.Settings.DEFAULT_KEEPON)) {
