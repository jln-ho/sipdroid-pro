package org.sipdroid.sipuapro.phone;
...
public class CallCard extends FrameLayout
    ...
    private static LinearLayout vuMeters;
    private static ProgressBar vuInput;
    private static ProgressBar vuOutput;
    ...
    protected void onFinishInflate() {
        ...
        vuInput = (ProgressBar) findViewById(R.id.vuInput);
        vuOutput = (ProgressBar) findViewById(R.id.vuOutput);
        vuMeters = (LinearLayout) findViewById(R.id.vuMeters);
    }
    ...
    public static void updateOutputVU(int value){
    	if(vuMeters != null && vuMeters.getVisibility() == VISIBLE){
    		vuOutput.setProgress(vuOutput.getMax()+value);
    	}
    }
...

 {
        ...
        //enable vu Meters
        findViewById(R.id.vuMeters).setVisibility(View.VISIBLE);
    }
